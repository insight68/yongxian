...
import "./views/home";
import "./views/team-structure";
import "./views/mission-control";
...
function buildChatProps(state, ctx) {
    return {
...
export function renderApp(state) {
    ...
    <div class="shell ${isChat ? "shell--chat" : ""} ${chatFocus ? "shell--chat-focus" : ""} ${state.settings.navCollapsed ? "shell--nav-collapsed" : ""} ${state.onboarding ? "shell--onboarding" : ""}">
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${state.tab === "team-structure"
        ? html `
                <openclaw-view-team-structure></openclaw-view-team-structure>
              `
        : nothing}

        ${state.tab === "mission-control"
        ? html `
                <openclaw-view-mission-control></openclaw-view-mission-control>
              `
        : nothing}

        ${state.tab === "statistics"
        ? html `
                <openclaw-view-usage></openclaw-view-usage>
              `
        : nothing}
