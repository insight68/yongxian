...
import { handleAgentEvent, resetToolStream } from "./app-tool-stream";
import { loadAgents } from "./controllers/agents";
import { loadAssistantIdentity } from "./controllers/assistant-identity";
import { loadChatHistory } from "./controllers/chat";
import { handleChatEvent } from "./controllers/chat";
import { loadDevices } from "./controllers/devices";
import { addExecApproval, parseExecApprovalRequested, parseExecApprovalResolved, removeExecApproval, } from "./controllers/exec-approval";
...
function applySessionDefaults(host, defaults) {
    ...
    const shouldUpdateSettings = nextSettings.sessionKey !== host.settings.sessionKey ||
