...
const PRODUCT_CATEGORY_LABELS = Object.fromEntries(PRODUCT_CATEGORY_RULES.map((rule) => [rule.id, rule.label]));
/**
 * Featured product management skills to highlight
 */
const FEATURED_PRODUCT_SKILL_KEYS = new Set([
    "feature-spec",
    "roadmap-management",
 ...
 */
let ProductManagementView = class ProductManagementView extends AssistantViewBase {
...
ProductManagementView = __decorate([
    customElement("openclaw-view-product-management")
], ProductManagementView);
export { ProductManagementView };
