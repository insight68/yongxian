...
import { filterSkillsByCategory, } from "../../config/skill-category-mappings";
/**
 ...
 */
const createPlaceholderSkillEntry = (definition, assistantName) => {
 ...
 */
const buildSkillEntriesWithPlaceholders = (skills, definitions, featuredKeys, assistantName) => {
 ...
 */
export class AssistantViewBase extends LitElement {
    constructor() {
        super(...arguments);
        // ========== State ==========
    ...
    static { this.styles = ASSISTANT_VIEW_STYLES; }
    /**
    ...
    getSkillEntries() {
        ...
        return buildSkillEntriesWithPlaceholders(skills, definitions, this.featuredSkillKeys, this.pageTitle);
    }
    /**
     ...
     */
    renderChatDock(selectedSkillDesc) {
    ...
    render() {
        ...
        const selectedSkillEntry = this.selectedSkillKey
            ...
            : null;
        const selectedSkillDesc = selectedSkillEntry?.mapping.description ?? "Click any skill above to inject prompt into chat";
        return html `
...
], AssistantViewBase.prototype, "skillsReport", void 0);
__decorate([
    property({ attribute: false })
], AssistantViewBase.prototype, "chatProps", void 0);
__decorate([
    property({ attribute: false })
], AssistantViewBase.prototype, "renderChat", void 0);
__decorate([
    state()
], AssistantViewBase.prototype, "selectedSkillKey", void 0);
__decorate([
    state()
], AssistantViewBase.prototype, "panelCollapsed", void 0);
